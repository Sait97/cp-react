...
export const Header = withRouter((props) => {
  ...
  <a className="navbar-brand" href="/">Course Project</a>
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto ">
      ...
      <li className="nav-item">
        <Link to="/tasks/create" className="nav-link">Create Tasks</Link>
      </li>
    </ul>
    ...
    <span className="logout-btn ml-2 btn btn-outline-danger my-2 my-sm-0" style={logoutStyle} onClick={onLogout} >Logout</span>
  </div>
</nav>
