...
export function UserEdit(props) {
    ...
    const [editedUser, setEditedUser] = useState({username: '', age: 0, email: '', password: '', isAdmin: false, isActive: false });
        ...
        <div className="user-edit-wrapper">            
            ...
            { error && <span className="text-danger">{error}</span> }
                <div className="form-group">
                    ...
                    <input type="text" name="username" id="username" className="form-control" onChange={onInputChange} value={editedUser.username} />
                </div>
                <div className="form-group">
                ...
                <div className="d-flex buttons-spc">
                <div className="form-group">
